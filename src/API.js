...
const getAgentAvaialbality = async () => {
    ...
    console.log(agentAvailabilityURL);
    const headers = new Headers();
    ...
    try {
        ...
        const agentAvailableJSON = await agentAvailableReq.json(); consoleLog(agentAvailableJSON);
...
const createChatSession = async () => {
    ...
    try {
        ...
        const chatSessionJSON = await saleforceSession.json(); consoleLog(chatSessionJSON);
...
const createChatInitRequest = async () => {
    ...
    try {
        ...
        chatReq1 = await chatReq.json(); consoleLog("createChatInitRequest:"+chatReq1);
    } catch (error) {
        takeBotIconMsg(
            "takeda-mi-chatbot-bot-msg takeda-mi-chatbot-icon-delay",
            errorMsg,
...
const messagePoll = async () => {
    ...
    try {
        ...
        systemMessages = await saleforcemessages.json(); consoleLog("messagePull:" + systemMessages);
...
const sendChatMessage = async (userRes) => {
    ...
    try {
        ...
        chatReq1 = await chatReq.json(); consoleLog("sendChatMessage:" + chatReq1);
    } catch (error) {
        console.error(error);
    }
};
